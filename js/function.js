...
scroller.addEventListener('scroll', function (event) {
	if (event.scrollLeft >= barrier_1.offsetLeft - barrier_1.offsetWidth/2 - window.innerWidth/2) {
		athlete.style.bottom = "8rem";
	}
	else {
		athlete.style.bottom = "1.5rem";
	}
	if (event.scrollLeft >= barrier_1.offsetLeft + barrier_1.offsetWidth + barrier_1.offsetWidth/2 - window.innerWidth/2) {
		athlete.style.bottom = "1.5rem";
	}
});
